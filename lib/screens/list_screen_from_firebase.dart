...
import 'package:flutter_data_1/providers/todo_firebase.dart';

class ListScreenFromFirebase extends StatefulWidget {
  @override
  _ListScreenFromFirebase createState() => _ListScreenFromFirebase();
}

class _ListScreenFromFirebase extends State<ListScreenFromFirebase> {
  List<Todo> todos = [];
