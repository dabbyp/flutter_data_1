...
import 'package:flutter_data_1/providers/todo_sqlite.dart';

class ListScreenFromSqlite extends StatefulWidget {
  @override
  _ListScreenFromSqlite createState() => _ListScreenFromSqlite();
}

class _ListScreenFromSqlite extends State<ListScreenFromSqlite> {
  List<Todo> todos = [];
